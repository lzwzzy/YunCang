                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="display-t">
                        <div class="display-tc animate-box" data-animate-effect="fadeIn">
                            <h1>联系我们</h1>
                            <h2>项目GitHub地址<a href="https://github.com/lzwzzy/YunCang" target="_blank">yuncang.com</a>
                            </h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-5 col-md-push-1 animate-box">
                    ...
                    <div class="fh5co-contact-info">
                        <h3>我们的信息</h3>
                        <ul>
                            <li class="address">大连市高新区软件园路8号, <br> 大连东软信息学院三期</li>
                            <li class="phone"><a href="tel://1234567920">+ 1235 2355 98</a></li>
                            <li class="email"><a href="mailto:1129459766@qq.com">217@neusoft.com</a></li>
                            <li class="url"><a href="#">www.yuncang.com</a></li>
                        </ul>
                    </div>
...
<script src="<%=rootPath%>/welcomeResource/js/google_map.js"></script>
<!-- Main -->
