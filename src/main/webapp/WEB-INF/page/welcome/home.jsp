...
<div id="page">
    ...
    <header id="fh5co-header" class="fh5co-cover" role="banner"
            style="background-image:url(<%=rootPath%>/welcomeResource/images/img_bg_1.jpg);"
                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="display-t">
                        <div class="display-tc animate-box" data-animate-effect="fadeIn">
                            <h1>改变,因云仓而变</h1>
                            <p><a class="btn btn-primary btn-lg btn-learn" href="#">管理员入口</a> <a
                                    class="btn btn-primary btn-lg btn-video" href="/yuncang/index"><i
                                    class="icon-play"></i>商家入口</a></p>
                        </div>
                    </div>
                </div>
            </div>
