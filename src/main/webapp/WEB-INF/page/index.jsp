...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <li class="active"><a href="/index.html"><span class="glyphicon glyphicon-home"></span> 起始页</a></li>
        <li><a href="/widgets.html"><span class="glyphicon glyphicon-shopping-cart"></span> 采购</a></li>
        <li><a href="/charts.html"><span class="glyphicon glyphicon-tag"></span> 销售</a></li>
        <li><a href="/tables.html"><span class="glyphicon glyphicon-folder-close"></span> 仓库</a></li>
        <li><a href="/forms.html"><span class="glyphicon glyphicon-usd"></span> 资金</a></li>
        <li><a href="/panels.html"><span class="glyphicon glyphicon-list-alt"></span> 报表 &amp; Panels</a></li>
        <li class="parent ">
            <a href="#">
