...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <li class="active"><a href="/index.html"><span class="glyphicon glyphicon-dashboard"></span> 起始页</a></li>
        ...
        <li><a href="login.jsp"><span class="glyphicon glyphicon-user"></span> 用户</a></li>
    </ul>
